...
static NSArray<NSDictionary *> *YTKACENativeLayout(void) {
    return @[
        ...
        @{@"kind": @"row", @"title": @"Appearance & Themes"},
        @{@"kind": @"row", @"title": @"Display & 120Hz"},
...
static NSString *YTKACENativeSettingsSubtitle(NSString *title) {
    ...
    dispatch_once(&onceToken, ^{
        subtitles = @{
            ...
            @"Appearance & Themes": @"Custom OLED themes, accent colors, and styles",
            @"Display & 120Hz": @"120 FPS ProMotion, smooth scrolling, and frame pacing",
...
static UIImage *YTKACENativeSettingsIconImage(NSString *title) {
    ...
    dispatch_once(&onceToken, ^{
        symbols = @{
            ...
            @"Playback": @"playpause",
            @"Appearance & Themes": @"paintpalette",
            @"Display & 120Hz": @"speedometer",

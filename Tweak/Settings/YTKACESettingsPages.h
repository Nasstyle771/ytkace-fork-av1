...
FOUNDATION_EXPORT UIViewController *YTKACEMakeAppearanceOptionsController(void);
FOUNDATION_EXPORT UIViewController *YTKACEMakeDisplayRateOptionsController(void);
